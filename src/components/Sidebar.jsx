  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        key={item.name}
        to={item.to}
        className="text-white duration-100 ml-5 flex flex-row justify-start items-center my-10 font-bold hover:text-gray-500"
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240PX] py-10 px-4 bg-[#c2b4da]">
      ...
      <div className="absolute md:hidden block top-6 right-3 ">
        {mobileMenuOpen ? (
          <RiCloseLine
            className="text-white w-10 h-10 font-bold mr-2"
