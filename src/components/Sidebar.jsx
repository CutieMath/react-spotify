  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        key={item.name}
        to={item.to}
        className="duration-500 ml-5 flex flex-row justify-start items-center my-8 text-white font-bold hover:text-gray-500"
  ...
  return (
    <>
      ...
      <div className="absolute md:hidden block top-6 right-3">
        {mobileMenuOpen ? (
          <RiCloseLine
            className="w-10 h-10 text-white font-bold mr-2"
